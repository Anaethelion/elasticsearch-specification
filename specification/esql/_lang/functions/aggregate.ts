...
/** Counts the number of distinct values. @esql_function aggregate */
...
/** Returns the maximum value. @esql_function aggregate */
...
/** Returns the minimum value. @esql_function aggregate */
...
/** Returns the top N values sorted by a sort field. @esql_function aggregate */
...
/** Collects all values into a multi-valued field. @esql_function aggregate */
...
/** Computes the weighted average. @esql_function aggregate */
export function WEIGHTED_AVG(value: double | integer | long, weight: double | integer | long): double

/** Returns the first value ordered by a sort field. @esql_function aggregate */
...
/** Returns the last value ordered by a sort field. @esql_function aggregate */
...
/** Returns a random sample of values. @esql_function aggregate */
