...
/** Appends values from two multi-valued fields. @esql_function scalar */
...
/** Returns the average of a multi-valued numeric field. @esql_function scalar */
export function MV_AVG(field: double | integer | long | unsigned_long): double

/** Concatenates multi-valued strings with a delimiter. @esql_function scalar */
export function MV_CONCAT(field: keyword | text, delim: keyword | text): keyword

/** Returns true if a multi-valued field contains a value. @esql_function scalar */
...
/** Returns the number of values. @esql_function scalar */
...
/** Removes duplicate values. @esql_function scalar */
...
/** Returns the first value. @esql_function scalar */
...
/** Returns the last value. @esql_function scalar */
...
/** Returns the maximum value. @esql_function scalar */
...
/** Returns the minimum value. @esql_function scalar */
...
/** Returns a slice of values. @esql_function scalar */
...
/** Returns the intersection of two multi-valued fields. @esql_function scalar */
...
/** Returns true if two multi-valued fields share any values. @esql_function scalar */
...
/** Returns the union of two multi-valued fields. @esql_function scalar */
...
/** Combines two multi-valued fields into pairs with a delimiter. @esql_function scalar */
